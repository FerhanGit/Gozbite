...
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'form/form.html', 31, false),array('block', 'oa_form_element', 'form/form.html', 39, false),)), $this); ?>

<div class='form-message form-message-error' id="errors" <?php if ($this->_tpl_vars['form']['errors']): ?><?php else: ?>style="display:none"<?php endif; ?>>
    <?php echo OA_Admin_Template::_function_t(array('str' => 'FormContainsErrors'), $this);?>
