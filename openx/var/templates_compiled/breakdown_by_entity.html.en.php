        ...
        <tbody>
            ...
            <?php if ($this->options['strict'] || (is_array($t->aEntitiesData)  || is_object($t->aEntitiesData))) foreach($t->aEntitiesData as $e) {?><tr class="<?php echo htmlspecialchars($e['htmlclass']);?>">
                <td class="<?php echo htmlspecialchars($e['nameclass']);?>" nowrap="nowrap">
                    ...
                    <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) if ($t->entityLink($e['prefix'])) { ?><a href="<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) echo htmlspecialchars($t->entityLink($e['prefix']));?>&<?php echo htmlspecialchars($e['linkparams']);?>"><?php if ($e['name'])  {?><?php echo htmlspecialchars($e['name']);?><?php } else {?><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'tr'))) echo htmlspecialchars($t->tr("strUntitled"));?><?php }?></a><?php }?>
                    <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) if (!$t->entityLink($e['prefix'])) { ?><span><?php if ($e['name'])  {?><?php echo htmlspecialchars($e['name']);?><?php } else {?><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'tr'))) echo htmlspecialchars($t->tr("strUntitled"));?><?php }?></span><?php }?>
                </td>
                <?php if ($this->options['strict'] || (is_array($t->aColumns)  || is_object($t->aColumns))) foreach($t->aColumns as $ck => $cv) {?>
