...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'account-switch-search.html', 30, false),array('function', 'boldSearchPhrase', 'account-switch-search.html', 33, false),array('function', 't', 'account-switch-search.html', 45, false),)), $this); ?>
...
"><?php echo OA_Admin_Template::_function_boldSearchPhrase(array('text' => ((is_array($_tmp=$this->_tpl_vars['accountName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)),'search' => $this->_tpl_vars['query']), $this);?>
</a>
    </li>
