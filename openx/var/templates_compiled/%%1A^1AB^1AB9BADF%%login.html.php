<?php /* Smarty version 2.6.18, created on 2014-11-15 12:44:14
         compiled from login.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'login.html', 30, false),array('function', 't', 'login.html', 36, false),array('function', 'tabindex', 'login.html', 53, false),array('function', 'phpAds_ShowBreak', 'login.html', 76, false),)), $this); ?>

<?php if ($this->_tpl_vars['uiEnabled']): ?>
<br />
<form name="login" method="post" action="<?php echo ((is_array($_tmp=$this->_tpl_vars['formAction'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
" />
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td width="80" valign="bottom"><img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['assetPath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
