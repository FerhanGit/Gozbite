...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'option.html', 6, false),array('function', 't', 'option.html', 7, false),)), $this); ?>

<?php if ($this->_tpl_vars['oxInstalled']): ?>
<form id='settingsform' name='settingsform' ENCTYPE='multipart/form-data' method='post' action='<?php echo $this->_tpl_vars['formUrl']; ?>
