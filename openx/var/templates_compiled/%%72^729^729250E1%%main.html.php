...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'layout/main.html', 82, false),array('insert', 'OA_Admin_UI_CustomHeader', 'layout/main.html', 97, false),array('insert', 'OA_Admin_UI_CustomFooter', 'layout/main.html', 200, false),array('function', 't', 'layout/main.html', 110, false),)), $this); ?>
...
<body class="hasInterface <?php if ($this->_tpl_vars['showContentFrame'] || $this->_tpl_vars['showSidebar']): ?>hasGradient<?php endif; ?> <?php if ($this->_tpl_vars['showSidebar']): ?>hasSidebar<?php endif; ?>" onload="initPage();">
...
<?php if ($this->_tpl_vars['buttonReportBugs']): ?>
        <li class="buttonReportBugs"><a href="http://www.openx.org/support/reporting-bugs" target="_blank"><?php echo OA_Admin_Template::_function_t(array('str' => 'Report bug'), $this);?>
</a></li>
<?php endif; ?>
