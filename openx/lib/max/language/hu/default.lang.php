...
$GLOBALS['strOverview']				= "Áttekintés";
...
$GLOBALS['strAvg'] 				= "Átlag";
$GLOBALS['strAverage']				= "Átlag";
...
$GLOBALS['strCTRShort'] 			= "Átkattintás";
$GLOBALS['strCTR'] 				= "Átkattintás";
...
$GLOBALS['strMoveToNewCampaign']		= "Áthelyezés új kampányba";
...
$GLOBALS['strMoveToNewAffiliate']		= "Áthelyezés új kiadóhoz";
...
$GLOBALS['strErrorViews'] 			= "Írja be a letöltések számát, vagy jelölje be a korlátlan jelölőnégyzetet !";
$GLOBALS['strErrorNegViews'] 			= "A negatív letöltések nem engedélyezettek";
$GLOBALS['strErrorClicks'] 			= "Írja be a kattintások számát, vagy jelölje be a korlátlan jelölőnégyzetet !";
...
$GLOBALS['strErrorDBNoDataPlain']		= "A ".$phpAds_productname." adatbázissal kapcsolatos probléma miatt nem lehet adatokat kikeresni vagy tárolni. ";
$GLOBALS['strErrorDBNoDataSerious']		= "Az adatbázissal kapcsolatos komoly probléma miatt a ".$phpAds_productname." nem tudott adatokat kikeresni";
...
$GLOBALS['strErrorDBSubmitBug']			= "Ha ez a probléma megismételhető, akkor lehet, hogy a ".$phpAds_productname." hibája okozta. Jelentse a következő adatokat a ".$phpAds_productname." fejlesztőinek. Amennyire csak lehet, próbálja meg pontosan ismertetni azokat a műveleteket, melyek ezt a hibát okozták.";
$GLOBALS['strMaintenanceNotActive']		= "Az utóbbi 24 órában nem történt meg a karbantartás parancsfájl futtatása. \\nA ".$phpAds_productname." megfelelő működéséhez óránként futtatás szükséges. \\n\\nAz Administrator guide kézikönyvben részletes tájékoztatót olvashat \\na karbantartás parancsfájl beállításáról.";
...
$GLOBALS['strGlobalSettings'] = "Általános beállítások";
$GLOBALS['strFinanceCTR'] = "Átkattintás";
...
$GLOBALS['strCTR_short'] = "Átkattintás";
...
$GLOBALS['strStatisticsLogging'] = "Általános Statisztikai Naplózás beállítások";
$GLOBALS['strMaintenaceSettings'] = "Általános karbantartási beállítások";
...
$GLOBALS['strClick-ThroughRatio'] = "Átkattintási arány";
