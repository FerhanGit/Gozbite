...
$GLOBALS['strConvertSWF']			= "<br />업로드한 플래시 파일에 URL을 포함시킬 수 있습니다. 업로드한 플래시 파일에 URL이 포함되어 있습니다. ". MAX_PRODUCT_NAME ."는 플래시 파일에 포함된 URL을 변환하지 않으면 배너에 대한 AdClick 수를 추적할 수 없습니다. 다음은 플래시 파일에 포함된 URL 목록입니다. 이 URL을 변환하려면 <b>변환</b>을 클릭하고, 아니면 <b>취소</b>를 클릭하세요.</b>.<br /><br />주의: <b>변환</b>을 클릭하면 업로드한 플래시 파일을 실제로 변경합니다.<br />원본 파일을 백업하십시오. 배너를 만드는데 사용한 플래시 파일의 버전에 상관없이 결과 파일은 플래시 4 파일로 생성합니다.<br /><br />";
...
$GLOBALS['strUploadOrKeepAlt'] = "현재 이미지를 이용하거나<br /> 다른 이미지를 업로드할<br /> 수 있습니다.";
$GLOBALS['strChannelLimitations'] = "전달유지 옵션";
$GLOBALS['strWeekDays'] = "평일(월-금)";
...
$GLOBALS['strZoneAppendSelectZone'] = "이 영역에 연결된 배너에 팝업이나 격자 배너 호출 코드를 항상 추가합니다.";
$GLOBALS['strNoTrackersToLink'] = "현재 이 영역에 연결할 켐페인이 없습니다.";
$GLOBALS['strConnTypeSale'] = "저장";
$GLOBALS['strNoTargetingStats'] = "현재 이용할 수 있는 통계가 없습니다.";
$GLOBALS['strAllAdvertisers'] = "총 광고주 수";
...
$GLOBALS['strNoConversionLoggedInInterval'] = "이 기간 동안의 보고서에 기록된 AdViews가 없습니다.";
...
$GLOBALS['strNoAdminInterface'] = "서비스를 이용할 수 없습니다.";
