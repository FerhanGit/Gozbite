...
+---------------------------------------------------------------------------+
$Id: maintenance.lang.php 37157 2009-05-28 12:31:10Z andrew.hill $
*/
...
$GLOBALS['strServerCommunicationError'] = "<b>Связи с сервером обновлений нет, поэтому ".MAX_PRODUCT_NAME." не в состоянии проверить, доступна ли новая версия в данный момент. Пожалуйста, повторите попытку позже.</b>";
?>