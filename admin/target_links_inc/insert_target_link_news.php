...
{   
	...
	$sql="SELECT DISTINCT(tl.id) as 'id', n.title as 'title', tl.news_category as 'news_category', tl.fromD as 'fromD', tl.toD as 'toD'  FROM target_links_news tl, news n, news_category_list ncl  ORDER BY toD"; 
	$conn->setsql($sql);
    $conn->getTableRows();
    $result=$conn->result;
    $num=$conn->numberrows;
