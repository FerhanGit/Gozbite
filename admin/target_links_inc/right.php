<div id="orange_dqsno" style="float:left;">
    <div id="orange_dqsno_otpred" align="center" style="float:left; width:140px; height:18px; padding:0px 5px 2px 5px; color: #FFFFFF; font-size: 12px; font-weight: bold; font-family: Arial, Helvetica, sans-serif; background-image:url(images/right_gorno_<?=$theme_color?>.png);">Информация 
...
<div id="BANER-LEFT" align="justify" style="float:left; width:148px;  font-weight:normal; font-size:12px; color:#666666; padding:10px 0px 10px 0px;  border-left: 1px solid #999999;border-right: 1px solid #999999;">
  <div style="float:left;margin:5px;">dsdfgdfg
	dfgdfg
	dfg	dsdfgdfg
	dfgdfg
	dfg	dsdfgdfg
...
<div style="float:left; width:148px; height:30px;  border-left: 1px solid #999999;border-right: 1px solid #999999;">
