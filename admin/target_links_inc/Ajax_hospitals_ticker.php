<?php
   ...
   if($numPics>0 && is_file('../pics/firms/'.$resultPics[0]['url_thumb'])) $picFile= 'pics/firms/'.$resultPics[0]['url_thumb'];
   ...
   $response .= '<div style="float:left;background-image:url(images/fon_header_green.png); margin-left:0px;margin-bottom:0px; height:20px; width:245px; background-repeat:no-repeat; font-size:12px; color:#FFFFFF;">';
   ...
   $response .= '<div style="float:left;margin-right:10px; border:double; border-color:#666666; height:80px; width:80px;" ><a href="?firmID='.$Itm['id'].'"><img width="80" height="80" src="'.$picFile.'" /></a></div>';
