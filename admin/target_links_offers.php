...
{ 
	...
	$sql="INSERT INTO target_links_offers SET firm_id='".$_POST['firmID']."',
											 hotel_id='".$_POST['hotelID']."',
											 category='".$_POST['offer_category']."',
											 loc_id ='".$_POST['loc_id']."',
...
{		
	...
	$sql="DELETE FROM target_links_offers WHERE id='".$_REQUEST['delete']."'"; 
	$conn->setsql($sql);
    $conn->updateDB();
