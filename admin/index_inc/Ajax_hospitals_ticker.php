<?php
   ...
   $response = '';
	...
	for($i=0;$i<$numItms;$i++)
	{
	   ...
	   $response .=	'<div style="float:left; width:320px;color:#009900; font-size:11px;"cursor:pointer;cursor:hand;" onClick="javascript:document.location.href=\'hospitals.php?firmID='.$Itm[$i]['id'].'\'" onMouseover="this.style.backgroundColor=\'#F7F7F9\';" onMouseout="this.style.backgroundColor=\'transparent\';">';                
	   $response .= '<table><tr>';
