...
<script language="javascript" src="edit_bolest_simptoms/ajax.js"></script>
<link rel="stylesheet" href="edit_bolest_simptoms/css.css" type="text/css">
 
   
</head>
<body style="color:#FF0000;font-size:14px;" onload="getagents('name','')">

<form name = "searchform" method = "POST" action = "edit_bolest_simptoms.php" >
  ...
  <div id="CENTER" style="float:left;margin-left:0px;width:660px;">
     ...
     <div id="MAIN" style="float:left; width:500px; margin-top:0px;">         
		<fieldset style="margin:10px;">
		   <?php
		      print "<legend>&nbsp;Болести | Симптоми;</legend>\n";
		          
		   ?>
			<div id="hiddenDIV" style=" background-color:white; border: 0px solid black;"></div>     
   		</fieldset>
     </div>
