...
// =============================== SIMPTOMS ========================================	
   ...
   if($numPics[$i]>0 && is_file('../pics/bolesti/'.$resultPics[$i][0]['url_thumb'])) $picFile= 'pics/bolesti/'.$resultPics[$i][0]['url_thumb'];
	   ...
	   $response .=	'<div style="float:left;width:320px;font-size:11px;cursor:pointer;cursor:hand;background-color:#F9FBFF;" onClick="javascript:document.location.href=\'bolesti.php?bolestID='.$Itm[$i]['id'].'\'" onMouseover="this.style.backgroundColor=\'#F7F7F9\';" onMouseout="this.style.backgroundColor=\'#F9FBFF\';">';
	   $response .= '<table><tr>';
	   $response .= '<td >';
