<?php
   ...
   require_once("../inc/dblogin.inc.php");
	...
	for($i=0;$i<$numItms;$i++)
	{
	   ...
	   $response .=	'<div style="float:left;width:320px;font-size:11px;cursor:pointer;cursor:hand;background-color:#F9FBFF;" onClick="javascript:document.location.href=\'posts.php?postID='.$Itm[$i]['postID'].'\'" onMouseover="this.style.backgroundColor=\'#F7F7F9\';" onMouseout="this.style.backgroundColor=\'#F9FBFF\';">';
	   $response .= '<table><tr>';
	   $response .= '<td >';
