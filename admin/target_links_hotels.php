...
if ((isset($_POST['vavedi'])) && (!empty($_POST['doctorID'])) && (!empty($_POST['fromDate'])) && (!empty($_POST['toDate'])))
{ 
	
	
	$sql="INSERT INTO target_links_doctors SET doctor_id='".$_POST['doctorID']."',
											 loc_id='".$_POST['cityName']."',
											 category='".$_POST['doctor_category']."',
...
{		
	...
	$sql="DELETE FROM target_links_doctors WHERE id='".$_REQUEST['delete']."'"; 
	$conn->setsql($sql);
    $conn->updateDB();
