<?php
 ...
 $response ='';
	...
	for($i=0;$i<$numItms;$i++)
	{
	   ...
	   $response .=	'<div style="float:left;width:320px;font-size:11px;cursor:pointer;cursor:hand;background-color:F9FBFF;" onClick="javascript:document.location.href=\'doctors.php?doctorID='.$Itm[$i]['id'].'\'" onMouseover="this.style.backgroundColor=\'#F7F7F9\';" onMouseout="this.style.backgroundColor=\'transparent\';">';
	   $response .= '<table><tr>';
	   $response .= '<td >';
