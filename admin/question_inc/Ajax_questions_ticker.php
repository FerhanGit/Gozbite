<?php
   ...
   if(eregi('.jpg','../pics/news/'.$Itm['picURL'])) $picFile= 'pics/news/'.$Itm['picURL'];
   else $picFile = 'pics/news/no_photo_big.png';
    ...
    $response .= '<div style="float:left;background-color:lightblue;margin-left:10px;color:#467B99;">'.substr($Itm['body'],0,140).'...<div align="right"><a href="news.php?&newsID='.$Itm['newsID'].'">Още</а></div></div>'; 
