...
<div style="float:left; margin-top:10px; width:420px;">
   ...
   <table>						
				<tr>
                      	<td align="right">Ключова дума в заглавието на Статията:</td>
                        <td colspan="3"><input type="text" name="post_title" id="post_title"  style="overflow:no;width:200px;" /></td>
                    </tr>
				 <br /> <br />
				 <tr>
                      	<td align="right">Ключова дума в текста на Статията:</td>
                        <td colspan="3"><input type="text" name="post_body" id="post_body"  style="overflow:no;width:200px;" /></td>
                    </tr>
				 <br /> <br />

				 <tr>
                      	<td align="right">Автор на Статията:</td>
                        <td colspan="3"><input type="text" name="post_autor" id="post_autor"  style="overflow:no;width:200px;" /></td>
                    </tr>
				 <br /> <br />	
				 
				 <tr>
                      	<td align="right">Ключова дума в източника на Статията:</td>
                        <td colspan="3"><input type="text" name="post_source" id="post_source"  style="overflow:no;width:200px;" /></td>
                    </tr>
				 <br /> <br />		 
    					...
    					<td colspan="2" align="left">По колко на страница?:
                              ...
                              <div  id = "city" style = "float:left; overflow-y: auto;overflow-x: none; border: 1px solid #cccccc;">
                                <select style="width:100px;" name="orderby" id="orderby" >
					  				...
					  				<option value="post_autor">Автор</option>
					  				<option value="post_title">Заглавие</option>
					  				<option value="post_body">Съдържание</option>
					  				<option value="post_category">Категория</option>
					  				<option value="post_source">Източник</option>
