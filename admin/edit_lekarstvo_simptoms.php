...
<script language="javascript" src="edit_lekarstvo_simptoms/ajax.js"></script>
<link rel="stylesheet" href="edit_lekarstvo_simptoms/css.css" type="text/css">
 
   
</head>
<body style="color:#FF0000;font-size:14px;" onload="getagents('name','')">

<form name = "searchform" method = "POST" action = "edit_lekarstvo_simptoms.php" >
