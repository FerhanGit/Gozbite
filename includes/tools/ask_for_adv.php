   ...
   if(isset($_REQUEST['sendToFriend'])) {
      ...
      if(strlen($errors) <= 0) 
      {
      	...
      	//error_reporting(E_ALL);
			...
			$mail->WordWrap = 100; 
			$mail->Subject    = "Zapitvane za reklama ot $ownName ";
...
<head>
   ...
   <title>GoZBiTe.Com | Изпрати запитване за рекламно участие</title>
   ...
   <tr>
      ...
      <td valign = "top" bgcolor = "#F7F7F7" align = "center">
         <table border = "0" cellspacing = "0" cellpadding = "3">
            <caption><strong>Запитване за рекламно участие в портала GoZBiTe.Com</strong><br />
            ...
            <tr>
               <td align = "right"><label for = "txt">Текст на запитването:</label><br /> <br /> (Напишете услугата или продукта към кото проявявате интерес)</td>
