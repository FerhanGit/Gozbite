...
if (isset($_REQUEST['edit_btn']))
{
	...
	$insert_edit_post .='<script type="text/javascript">
     	...
     	window.location.href=\'редактирай-статия-'.$_REQUEST['edit'].','.myTruncateToCyrilic(get_post_nameByPostID($_REQUEST['edit']),50,'_','') .'.html\';
	</script>';
...
if (isset($_REQUEST['insert_btn']) && ($_REQUEST['post_title']!="") && ($_REQUEST['post_body']!="") && ($_REQUEST['post_category']!="") && ($_REQUEST['post_source']!=""))
{
	...
	$insert_edit_post .='<script type="text/javascript">
       	alert(\'Благодарим Ви! Веднага след като бъде прегледана от администратора Вашата Статия ще бъде публикувана!\'); 
     	window.location.href=\'редактирай-статия-'.$last_ID.','.myTruncateToCyrilic(get_post_nameByPostID($last_ID),50,'_','') .'.html\';
	</script>';
...
if (isset($_REQUEST['deletePic']) && isset($_SESSION['valid_user']))
{
	...
	$insert_edit_post .='<script type="text/javascript">
       window.location.href="редактирай-статия-'.$editID.','.myTruncateToCyrilic(get_post_nameByPostID($editID),50,'_','') .'.html";
	</script> ';
