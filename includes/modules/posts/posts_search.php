...
*/
	...
	require_once("includes/bootstrap.inc.php");
   	...
   	$posts_search = "";
	$posts_search .= '<div class="detailsDiv" style="float:left; width:660px;margin-bottom:20px; border-top:3px solid #0099FF; padding:5px; background-color:#F1F1F1;">';
...
$posts_search .= ' <div id="fastSearchDiv" style="margin-left:0px; margin-top:10px; margin-bottom:10px; height:20px; width:100px;">					
		...
		$posts_search .= '</div></div> <br style="clear:left;"/>';
				
				  
		$posts_search .= "<script type='text/javascript'>
			jQuery(document).ready(function($) {
			    getFastSearchPosts(jQuery('#post_category').val(), jQuery('#post_body').val(), jQuery('#fromDate').val(), jQuery('#toDate').val())
			});	
		</script>";
