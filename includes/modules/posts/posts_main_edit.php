	...
	$posts_main_edit .= ' </div>
		...
		$posts_main_edit .= '</td>
			 ...
			 <td valign="top">
				  ...
				  Заглавие на Статията *<br /> <textarea rows = "2" cols = "46"  name="post_title" id="post_title" >'.$resultEdit['title'].'</textarea>
			 	  <br /><br />
			 	  
			 	  Източник на Статията *<br /> <input type="text" size="20" style="width:330px;"   name="post_source" id="post_source" value="'.$resultEdit['source'].'" />
				  <br /> <br />';
		...
		$posts_main_edit .= 'Етикети към Статията <font style="font-size:10px;">(ключови думи, разделени със запетайки)</font> <br /> <textarea   maxlength="250" onkeyup="return ismaxlength(this)" rows = "2" cols = "46"  name="post_tags" id="post_tags" >'.implode(",",$post_edit_tags).'</textarea>';				  				  
	...
	$posts_main_edit .= '<br /> <br />
							  ...
							  {  
							  	$posts_main_edit .= "<div style='float:left; margin:0px; width:200px;' >";
					       			...
					       			<div style="float:left;cursor:pointer;" >
					       				<a onclick="if(!confirm(\'Сигурни ли сте?\')){return false;}" href="изтрий-снимка-на-статия-'.$resultEdit['picURL'].','.(!empty($resultEdit['title'])?myTruncateToCyrilic($resultEdit['title'],200,'_',''):'Статии').'.html"><img style="margin-left:1px;" src="images/page_white_delete.png" width="14" height="14"></a>
					       			</div>';
            ...
            <legend>.:: Видео Представяне ::.</legend>';
				...
				if(file_exists("../videos/posts/".$video_name.".flv"))
				{
					...
					<a onclick="if(!confirm(\'Сигурни ли сте?\')){return false;}" href="изтрий-видео-на-статия-'.$editID.','.(!empty($resultEdit['title'])?myTruncateToCyrilic($resultEdit['title'],200,'_',''):'Статии').'.html"><img style="margin-left:1px;" src="images/page_white_delete.png" width="14" height="14"></a>';
      ...
      <br /><br />';
        ...
        if ($_REQUEST['edit'] > 0)
		{
			 $posts_main_edit .= '<input type=\'checkbox\' id=\'active'.$_REQUEST['edit'].'\' name=\'active'.$_REQUEST['edit'].'\' '.((($resultEdit["active"] == 1) ? 'checked' : '')).' onclick=\'if(this.checked) {set_active(1,"post",'.$_REQUEST['edit'].','.$_SESSION['userID'].');} else{set_active(0,"post",'.$_REQUEST['edit'].','.$_SESSION['userID'].');} \'/> Статията е активна.<a href=\'#\' id=\'aktivirane_post\' style=\'z-index:1000;\'><img src=\'images/help.png\' /></a>';
