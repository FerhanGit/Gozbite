...
ini_set('memory_limit','512M');
	...
	function download_url($url)
	{
	   	...
	   	$snoopy = new Snoopy();print_r($snoopy);
...
*/
	...
	$page_url 	= 'http://receptite.info/category/liubopitno/sosove/';
...
preg_match_all("/<div(.*?)class=\"post item\">(.*?)<a href=\'([^>].*?)\'>(.*?)/is", $patna_obstanovka, $matches);
