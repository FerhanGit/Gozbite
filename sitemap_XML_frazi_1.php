...
// ----------------------------------------- Афоризми -----------------------------------------------
	$sql="SELECT a.aphorismID as 'aphorismID', a.date as 'date', a.title as 'title', a.body as 'body', a.picURL as 'picURL', a.autor as 'autor', a.autor_type as 'autor_type' FROM aphorisms a WHERE a.active = '1' ORDER BY RAND(), a.date DESC LIMIT 0,50000";
	$conn->setsql($sql);
	$conn->getTableRows();
	$result   = $conn->result;
