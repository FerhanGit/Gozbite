...
_bsn.AutoSuggest = function (fldID, param) {
   ...
   if(!this.oP.noresults)
      this.oP.noresults = "Няма резултат!";
...
_bsn.AutoSuggest.prototype.doAjaxRequest = function () {
   ...
   // Create ajax request
   var url  = this.oP.script + encodeURIComponent(this.oP.varname) + "=" + encodeURIComponent(val);
...
_bsn.AutoSuggest.prototype.setHighlightedValue = function () {
   if (this.iHighlighted) {
      ...
      if(kArr.length > 1) {
         kArr.pop();
         kArr.push(this.aSuggestions[this.iHighlighted-1].value);

         this.sInput = this.fld.value = kArr.join(", ") + ", ";
      } else {
