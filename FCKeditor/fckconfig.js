...
FCKConfig.ToolbarSets["Default"] = [
	['Bold','Italic','Underline','-','OrderedList','UnorderedList','-','Outdent','Indent'],

	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Paste','PasteText','PasteWord','-'],
	['Link','Unlink','-','Undo','Redo','-','RemoveFormat','Table','TextColor','BGColor','Image','Source']
] ;
...
FCKConfig.FontSizes		= '1/11px;2/xx-small;3/x-small;4/small;5/medium;6/large;7/x-large;8/xx-large' ;
FCKConfig.FontFormats	= 'div;p;pre;address;h1;h2;h3;h4;h5;h6' ;
